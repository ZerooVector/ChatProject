...
# Form implementation generated from reading ui file '/home/jh/code/QtDemo/Project_Github/ChatProject/UI/final.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.contactFriendList = QtWidgets.QListWidget(self.contactFriendPage)
        self.contactFriendList.setObjectName("contactFriendList")
        self.verticalLayout.addWidget(self.contactFriendList)
        ...
        self.addFriendList = QtWidgets.QListWidget(self.addFriendPage)
        self.addFriendList.setObjectName("addFriendList")
        item = QtWidgets.QListWidgetItem()
        self.addFriendList.addItem(item)
        self.verticalLayout_2.addWidget(self.addFriendList)
        self.contactListStack.addWidget(self.addFriendPage)
        self.addAccountBtn = QtWidgets.QPushButton(self.tab_3)
        ...
        self.ManageGroup = QtWidgets.QPushButton(self.GroupTab)
        self.ManageGroup.setGeometry(QtCore.QRect(700, 440, 89, 25))
        self.ManageGroup.setObjectName("ManageGroup")
        self.ChangeInformation = QtWidgets.QPushButton(self.GroupTab)
        self.ChangeInformation.setGeometry(QtCore.QRect(700, 360, 89, 25))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.addFriendList.setSortingEnabled(True)
        __sortingEnabled = self.addFriendList.isSortingEnabled()
        self.addFriendList.setSortingEnabled(False)
        item = self.addFriendList.item(0)
        item.setText(_translate("MainWindow", "新建项目"))
        self.addFriendList.setSortingEnabled(__sortingEnabled)
        ...
        self.ChangeInformation.setText(_translate("MainWindow", "修改个人信息"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.GroupTab), _translate("MainWindow", "Group"))
